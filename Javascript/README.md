...
Hiermit wird jeder Person, die eine Kopie dieser Software und der zugehörigen Dokumentationsdateien (die „Software“) erhält, die unentgeltliche Genehmigung erteilt, mit der Software uneingeschränkt zu verfahren, einschließlich, aber nicht beschränkt auf die Rechte, die Software zu verwenden, zu kopieren, zu ändern, zusammenzufügen, zu veröffentlichen, zu verteilen, unterzulizenzieren und dies Personen zu gestatten, denen die Software zur Verfügung gestellt wird, vorbehaltlich der folgenden Bedingungen:
